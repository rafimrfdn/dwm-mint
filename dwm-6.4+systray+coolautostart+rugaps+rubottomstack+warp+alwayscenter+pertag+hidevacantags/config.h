...
static const char *const autostart[] = {
  ...
  "sh", "/home/mint/.config/autostart/dwm-autostart.sh", NULL, 
  NULL /* terminate */
};
...
/* powermenu */
static const char *powermenu[] = { "/home/mint/.scripts/powermenu.sh", NULL };
...
static Key keys[] = {
  ...
  // powermenu
    ...
    // note
    { MODKEY, XK_n, spawn, SHCMD("alacritty -e ~/.scripts/notetaker.sh") },
    // File explorer
